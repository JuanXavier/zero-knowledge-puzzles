...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 2]); // line circom 11
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_add(&expaux[2],&signalValues[mySignalStart + 1],&signalValues[mySignalStart + 2]); // line circom 12
Fr_eq(&expaux[0],&signalValues[mySignalStart + 0],&expaux[2]); // line circom 12
